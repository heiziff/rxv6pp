...
ULIB = $U/ulib.o $U/usys.o $U/printf.o $U/umalloc.o $U/bmalloc.o $U/mmap-mock.o $U/futex.o $U/user.o
...
QEMUOPTS += -netdev user,id=meinrtl,hostfwd=udp::5555-:1234 -device rtl8139,netdev=meinrtl
#network monitoring :)
